...
//    Serial.printf("Get int... %s\n", Firebase.RTDB.getInt(&fbdo, "/users/felipe/quarto/color") ? String(fbdo.to<int>()).c_str() : fbdo.errorReason().c_str());
    ...
    Serial.printf("Get string... %s\n", Firebase.RTDB.getString(&fbdo, "/users/felipe/quarto/color") ? fbdo.to<const char *>() : fbdo.errorReason().c_str());
    /*
